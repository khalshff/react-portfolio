    ...
    const Work = () => {
      return (
        ...
        scroll-mt-20'>
            ...
            <p className='text-center max-w-2xl mx-auto mt-5 mb-12'>Lorem ipsum dolor sit amet</p>

            <div className='grid grid-cols-(--grid-cols-auto) my-10 gap-5'>
            ...
            border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover duration-500'>Show more <Image src={assets.right_arrow_bold} alt='right arrow' className='w-4'/>
            </a>
            </div>
      )
    }
