    ...
    scroll-mt-20'>
      ...
      <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
        <div className='w-64 sm:w-80 rounded-3xl max-w-none'>
            <Image src={assets.profile_img} alt='user_img' className='w-full rounded-3xl'/>
        </div>
        <div className='flex-1 '>
            <p className='mb-10 max-w-2xl'>I am a software engineer based in Singapore who is deeply intrigued with the idea of creating practical solutions to real-world problems that would transform and enhance the lives of people around the world. My goal is to utilize my technical knowledge to conjure innovative and effective solutions.
            </p>
